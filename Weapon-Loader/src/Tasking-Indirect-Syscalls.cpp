...
NTSTATUS IndirectSyscalls::NtQueueApcThread(
		HANDLE ThreadHandle,
		void* ApcRoutine,
		PVOID ApcArgument1,
		PVOID ApcArgument2,
...
NTSTATUS IndirectSyscalls::NtCreateUserProcess(
...
NTSTATUS IndirectSyscalls::NtResumeThread(
		HANDLE ThreadHandle,
