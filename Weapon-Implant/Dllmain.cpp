...
bool HandleRelocations(PE_INFO* pPeInfo) {
...
bool ResolveMemoryProtections(PE_INFO* pPeInfo) {
...
bool RelocateSections(PE_INFO* pPeInfo, byte* RawDataBase) {
...
bool ResolveImports(PE_INFO* pPeInfo) {
...
void* GetEntryPoint(PE_INFO* pPeInfo) {
...
bool InitializeImageInformation(byte* ModuleBase, PE_INFO* pPeInfo) {
...
void TestFunctionAlertCompletion() {
    MessageBoxA(NULL, "Hello From Reflective DLL!", "Weapon-Implant", MB_OK);
}
